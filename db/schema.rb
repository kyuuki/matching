...
ActiveRecord::Schema.define(version: 20171012074200) do
  ...
  create_table "item_available_datetimes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["item_id"], name: "index_item_available_datetimes_on_item_id"
  end
  ...
  create_table "item_available_japan_places", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["item_id"], name: "index_item_available_japan_places_on_item_id"
    t.index ["japan_city_id"], name: "index_item_available_japan_places_on_japan_city_id"
  end
  ...
  create_table "item_services", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["item_id"], name: "index_item_services_on_item_id"
    t.index ["service_id"], name: "index_item_services_on_service_id"
  end
  ...
  create_table "japan_cities", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["japan_prefecture_id"], name: "index_japan_cities_on_japan_prefecture_id"
  end
  ...
  create_table "japan_users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["japan_prefecture_id"], name: "index_japan_users_on_japan_prefecture_id"
    t.index ["user_id"], name: "index_japan_users_on_user_id"
  end
